...
- **The page.** `assets/dashboard.html`, carrying the `curia-dashboard` proto stamp #70's rule requires. The read screens land on #264, settings on #265, the verbs on #266 and the chat on #267.
