...
- Never announce a dispatch. The daemon keeps dispatch mechanics on the ticket's editable status line. Never write "the agent is running", "spawning", "dispatched", or a session name with a state.
