...
- `src/resources.mjs`: the Docker resources of one installation, found and removed by the installation label. `curia uninstall` and `curia purge` share it.
