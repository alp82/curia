...
| [trusted-distribution.md](trusted-distribution.md) | npm, GitHub release, container, Compose, and provenance constraints for packaged Curia releases | Informational - grounds the release and installation lifecycle decisions on [Establish trusted npm and container distribution constraints](https://github.com/alp82/curia/issues/849) |
...
| [zmx.md](zmx.md) | zmx as a replacement for Curia's tmux terminal host | Rejected — good session fit, but the released control contract and host lifecycle don't meet Curia's safety bar |
