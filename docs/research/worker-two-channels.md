...
Resolves [#29](https://github.com/alp82/curia/issues/29) — can one worker session be both **structurally driveable by the daemon** and **multi-client attachable by humans**, without the daemon ever parsing a terminal? Run 2026-07-24 on Alp's desktop (same Hetzner stand-in as #19/#24/#25). Prototype code: [`prototypes/worker-two-channels/`](../../prototypes/worker-two-channels/).
