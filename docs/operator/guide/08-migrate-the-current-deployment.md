...
4. **Validation.** Checks the integrations, the artifacts, the configuration, the permissions, the absence of the source paths on the target, and one Test run, as in [4. Run the Test run](04-run-the-test-run.md).
