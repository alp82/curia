...
| `integrations` | `Full loop` | The [Full-loop gate](integration-setup.md#when-setup-is-ready) is ready on this read. | A warning with the gate's reason, such as `Waiting for Discord.` |
