...
- [ADR-0024](0024-the-overseer-chat-is-a-pane.md): The overseer chat is a pane, parked when idle. Both chat kinds share the pane runtime and the ADR-0021 take back, live panes get a settings cap of 3, a deploy is a forced park, and rehydration returns a pane on the next message. Pane hosting is built. Delivery, tool identity, rewind, and capacity work remain.
