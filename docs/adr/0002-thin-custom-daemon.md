...
The daemon body could be hermes-agent adopted wholesale, or a thin custom core that drives commodity parts. The call waited on live evaluations of the borrowed parts (the OpenACP bridge and the agent-host candidates).
...
- The agent host was deliberately not settled here. [ADR-0003](0003-tmux-ttyd-tailscale-worker-host.md) holds that pick.
