...
**Provenance**: [Which product requirements belong in Curia's first-use path? (#1023)](https://github.com/alp82/curia/issues/1023) and [Choose a simpler first-use and configuration experience (#1024)](https://github.com/alp82/curia/issues/1024), on [map #1017](https://github.com/alp82/curia/issues/1017).
...
- **Curia drops the Test run.** A new operator's first task is a real quick task in a watched repository, not a scripted acceptance run. Decided on [Choose a simpler first-use and configuration experience (#1024)](https://github.com/alp82/curia/issues/1024).
...
- Removing the Test run removes the Full loop's run and map, the Full-loop gate, and the `test-run` routing rows. Rehearsals need another way to create their tickets. The removal is planned on [map #1017](https://github.com/alp82/curia/issues/1017).
